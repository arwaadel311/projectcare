...
const validateObjectId = (value, helper) => {return Types.ObjectId.isValid(value) ? true : helper.message('In-valid objectId')}
export const generalFields = {
    ...
    phoneNumber: joi.string().pattern(new RegExp(/^01[0125][0-9]{8}$/)).required(),
